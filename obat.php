    ...
    <div class="department_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
           Berikut adalah informasi mengenai obat-obat an secara umum, semoga dapat membantu anda untuk menemukan obat yang tepat.
          </p>
        </div>
        <div class="row">
          <div class="col-md-3">
            <div class="box ">
              <div class="img-box">
                <img src="assets/images/obat.png" alt="">
              </div>
